...
export const OFFERS_MOCK_DATA: OfferType[] = [
  {
  ...
  {
    'id': 'f83220a8-aac0-469f-81e1-bc3fd3e83e6c',
  ...
  {
    'id': '7f702d65-71db-4eff-a46f-f338ca706db9',
...
export const OFFERS_NEIGHBOURHOOD_MOCK_DATA: OfferType[] = [
  {
    'id': 'a20a52b2-efc2-4b0f-9396-4bdfbe5e9543',
    'title': 'Wood and stone place',
    'type': 'house',
